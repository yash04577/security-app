...
const LoadingQr = ({ navigation }) => {
    const route = useRoute();
    const { billName } = route.params || {};
            ...
            {showPhoto && (
                <View style={styles.confirmButtonContainer}>
                    <View style={styles.buttonRow}>
                        ...
                        <TouchableOpacity onPress={() => navigation.navigate('SingleBillPage', { image, billName })} style={styles.confirmButton}>
