...
const Qr = ({ navigation }) => {
  ...
  const { selectedEmployee } = route.params || {}                      //Taking alll data
  const employeeId = selectedEmployee.id; // Replace 'your_id_here' with the desired ID
  ...
  const handleOk = () => {
    if (data) {
      ...
      let total = { selectedEmployee, requestBody }
      console.log(total);
      navigation.navigate('Pic', { total })
    } else {
