...
const machinePic = ({ navigation }) => {
    ...
    const imageUpload = async (data) => {
        const apiUrl = `${RBASE_URL}/employee/docs/uploadproofImage`; // Replace with the backend API URL
        try {
            ...
            showMessage({
                ...
                floating: true,
                duration: 5000,
                messageStyle: { width: 300 }, // Adjust the width to your desired value
            });
