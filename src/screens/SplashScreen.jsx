    ...
    showSplash ? (
      <View style={styles.container}>
        <View style={styles.centeredContent}>
          <Image style={styles.image} source={require('../../assets/metalogo.png')} />
          <Text>                     </Text>
          <Text style={{ color: '#283093', fontSize: 23 }} >Welcome to Chawla Ispat Group</Text>
          <Text>                     </Text>
          <ActivityIndicator size="large" color="black" />
        </View>
      </View>
    ) : (loginres?.status == 200 ? navigation.navigate('Home') : navigation.navigate('Login'))
  );
}
